...
const data = {
  title: "Elevating Your Business with Technical Prowess",
  description:
    "We empower your business for profitability with our talented marketing professionals.",
  ...
  points: [
    ...
    {
      icon: <IoIosCheckmarkCircle />,
      text: "End-to-end delivery support",
    },
    {
      icon: <IoIosCheckmarkCircle />,
